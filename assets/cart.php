...
<head>
  ...
  <link rel="icon" href="<?php echo base_url(); ?>img/favicon.png">
        ...
        <!-- swiper CSS -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/price_rangs.css">
        <!-- style CSS -->
          ...
          <div class="row align-items-center justify-content-center">
              <div class="col-lg-11">
                  <nav class="navbar navbar-expand-lg navbar-light">
                      <a class="navbar-brand" href="index.html"> <img src="<?php= base_url('assets/img/')?>" alt="logo"> </a>
