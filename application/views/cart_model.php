...
<div class="col-lg-12 col-md-12">
    ...
    <table class="items-list col-lg-12 col-md-12 table-hover">
        ...
        <tr class="item first rowid<?php echo $data['rowid'] ?>">
          ...
          <td class="qnt-count">
            <input class="quantity qty<?php echo $data['rowid'] ?> form-control" 
              ...
              <button type="button" class="btn btn-default" onclick="updateproduct('<?php echo $data['rowid'] ?>')">Update</button>
          <td class="total">Kshs <span class="subtotal subtotal<?php echo $data['rowid'] ?>">
                                              <?php echo $data['subtotal'] ?></span></td>
          <td class="delete"><i class="btn btn-danger" 
      ...
      <tr class="item">
        ...
        <td class="">Kshs <span class="grandtotal">0</span> </td>
        <td>&nbsp;</td>
      </tr>
    </tbody></table>
  </div>
...
<button type="button" class="btn btn-default" onclick="deleteproduct('all')">Clear Cart</button>
<a href="<?php echo base_url();?>index.php/welcome/billing_view">
...
$.ajax({
  type: "POST",
  url: "<?php echo base_url();?>index.php/welcome/update_cart",
